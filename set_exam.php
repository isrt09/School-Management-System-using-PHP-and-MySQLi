			...
			<div id="section">
				...
				<form action="">
					...
					<div class="rbox">
						...
						<br><br>									
						<label>Class</label>
						<select name="cla" required class="input3"></select>				
						<br><br>										
						<label>Subject</label><br>
						<select name="sub" required class="input3"></select>
						<br><br>
						<button type="submit" class="btn" name="submit">Add Exam Details</button><br><br>
					</div>
				</form>								
			</div>	
